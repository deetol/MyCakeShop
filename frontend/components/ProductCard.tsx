...
import { ProductData } from "./ProductDetailModal";
...
export default function ProductCard({ product, onViewDetails }: ProductCardProps) {
  ...
  return (
    <article
      ...
      className="bg-surface-container-lowest rounded-xl overflow-hidden card-hover flex flex-col border border-surface-container-low relative cursor-pointer"
    >
      {/* Tag Badge */}
      {product.tag && (
        <div
      ...
      {/* Image Container */}
      <div className="relative h-64 w-full bg-surface-container overflow-hidden group">
        <Image
          src={product.image}
          alt={product.name}
          fill
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="font-headline-md text-headline-md text-on-surface mb-2 truncate">
          {product.name}
        </h3>
